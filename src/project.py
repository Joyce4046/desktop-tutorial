...
class initface():
	def __init__(self, root):
		...
		self.btn1 = tk.Button(self.initface,text='小幫手Part 1',font = self.ft,bg="white",fg = 'pink',anchor = tk.Ｓ,command=self.change)
		self.btn1.grid()
		self.btn2 = tk.Button(self.initface,text='小幫手Part 2',font = self.ft,bg="white",fg = 'pink',anchor = tk.Ｓ,command=self.change)
		self.btn2.grid()
